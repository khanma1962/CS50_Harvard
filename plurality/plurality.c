...
void print_winner(void)
{
    ...
    {
        largest1 = candidates[1].votes ;
        c1 = candidates[1].name ;

        largest2 = candidates[0].votes ;
        c2 = candidates[0].name;

    }
    else if (candidates[0].votes >= candidates[1].votes)
    {
        largest1 = candidates[0].votes ;
        c1 = candidates[0].name ;

        largest2 = candidates[1].votes ;
        c2 = candidates[1].name;
